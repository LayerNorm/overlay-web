...
import {
  ...
  GroupKnowledgeBaseDefaultsQuery,
  GroupKnowledgeBaseDefaultRequest,
...
export const webApiBoundaryDefinitions = [
  ...
  },
  {
    ...
    schema: { query: GroupKnowledgeBaseDefaultsQuery },
    summary: 'List default knowledge bases assigned to groups',
    tag: 'Administration',
  },
  {
    method: 'POST',
    path: '/api/v1/admin/knowledge-bases/defaults',
    schema: { json: GroupKnowledgeBaseDefaultRequest },
    summary: 'Assign a default knowledge base to a group',
    tag: 'Administration',
  },
  {
    method: 'DELETE',
    path: '/api/v1/admin/knowledge-bases/defaults',
    schema: { json: GroupKnowledgeBaseDefaultRequest },
    summary: 'Remove a default knowledge base from a group',
    tag: 'Administration',
  },
  {
    method: 'GET',
  ...
  },
  {
    ...
    schema: { query: ProjectExportQuery },
    summary: 'Export a portable project archive',
    tag: 'Projects',
  },
  {
    method: 'GET',
    path: '/api/v1/projects/share-directory',
    schema: { query: ProjectShareDirectoryQuery },
    summary: 'List users, groups, and roles available for project sharing',
    tag: 'Projects',
  },
  {
    method: 'GET',
    path: '/api/v1/projects/grants',
    schema: { query: ProjectGrantListQuery },
  ...
  },
  {
    method: 'POST',
    path: '/api/v1/projects/grants',
    schema: { json: CreateProjectGrantRequest },
  ...
  },
  {
    method: 'DELETE',
    path: '/api/v1/projects/grants',
    schema: { json: DeleteProjectGrantRequest },
  ...
  },
  {
    ...
    summary: 'List administratively configurable models, tools, and connectors',
    tag: 'Administration',
  },
  {
    method: 'GET',
