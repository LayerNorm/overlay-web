...
export const webApiExcludedRouteDefinitions = [
  ...
  { routePath: '/api/v1/agents/[agentId]/threads/[threadId]', reason: 'Agent thread archive and deletion; boundary definition pending. Protected by workspace authorization.' },
