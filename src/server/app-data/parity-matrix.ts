...
export const ON_PREM_PARITY_MATRIX: readonly OnPremParityDomain[] = [
  ...
  },
  {
    ...
    name: 'Workspaces, teams, and invitations',
    targetPhase: 'P8',
    capabilities: [],
    routeRuleIds: ['workspaces'],
    exitGate: 'Workspace lifecycle, membership, invitations, guests, and cross-workspace isolation behave identically in both providers.',
  },
  {
    id: 'workspace-agents',
    name: 'Named workspace agents',
    targetPhase: 'P8',
    capabilities: [],
    routeRuleIds: ['workspace-agents'],
    exitGate: 'Agent definitions, room enrollment, and mention-first invocation enforce the same authorization without Convex.',
  },
  {
