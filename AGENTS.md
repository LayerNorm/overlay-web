...
| `docs/develop/browser-testing-with-playwright-mcp.md` | Any change to the Playwright MCP setup, tool usage patterns, or QA workflow. Add new workflow patterns or gotchas discovered during testing. |
