...
- Agent renames now update live across the editor title, DM header and empty state, and sidebar roster while typing, and persist to the agent's existing 1:1 DM title.
