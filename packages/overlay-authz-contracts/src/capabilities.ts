export const AUTHORIZATION_CAPABILITY_DEFINITIONS = [
  ...
  { key: 'governance.read', category: 'governance', label: 'View governance policies and reviews' },
  { key: 'governance.manage', category: 'governance', label: 'Manage governance policies and reviews' },
  { key: 'governance.export', category: 'governance', label: 'Export compliance evidence' },
