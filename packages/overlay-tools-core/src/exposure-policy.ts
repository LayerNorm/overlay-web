const DEFAULT_BASE_TOOL_IDS = [
  'search_knowledge',
  'search_in_files',
  // Knowledge-base tools are always available: a user can reference a knowledge
  // base at any point in a turn, and the model needs a scoped alternative to the
  // account-wide search tools.
