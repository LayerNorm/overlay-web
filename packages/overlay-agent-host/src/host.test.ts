...
import { OVERLAY_AGENT_PROTOCOL_VERSION, canonicalEnrollmentProof, canonicalHostRequestProof, type AgentHostCommand, type CommandAcknowledgement, type EventAcknowledgement, type EventBatch } from '@layernorm/agent-bridge-protocol'
