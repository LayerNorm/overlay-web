...
- **Workspace conversations and automation continuity** — Direct messages and channels now open their dedicated room experience, remain visible to active participants, refresh from durable conversation events, and preserve participant-attributed history. Automation chat links are validated and repaired instead of leaving the editor in an indefinite loading state.
