...
collapse and table removal transactionally. Schema 60 raises the minimum
compatible runtime to 60 because older runtimes still query the removed table;
take a database backup and treat this migration as an explicit rollback
boundary.
