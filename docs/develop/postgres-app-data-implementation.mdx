...
- Postgres app-data is not full Convex parity. Chat, projects, files, generated media, browser outputs, Daytona artifacts, memories, knowledge retrieval, and durable scheduled automations are supported; webhooks, API keys, billing records, and integrations remain disabled or unsupported.
