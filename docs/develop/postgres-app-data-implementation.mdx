...
- Postgres app-data is not full Convex parity. Chat, projects, files, generated media, browser outputs, and Daytona artifacts are supported; automations, webhooks, API keys, billing records, integrations, memory extraction, and vector search remain disabled or unsupported.
