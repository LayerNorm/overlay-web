...
Workspace Settings → Import tab
  ...
  → Channel picker (SLACKBOT_LIST_ALL_CHANNELS)
...
| UI | `src/features/workspaces/components/SlackImportPanel.tsx` | 5-step panel (connect → people → channels → progress → done) |
