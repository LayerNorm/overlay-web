...
Accepted on July 26, 2026. Phase 1 shipped the workspace foundation and Phase 2 shipped the workspace-aware Chats information architecture on July 29, 2026. The `workspaces` and `collaborativeChats` app features are enabled; Direct Message creation, Channels, named agents, universal sharing, and shared multi-tenant deployment remain disabled until their individual release gates pass.
