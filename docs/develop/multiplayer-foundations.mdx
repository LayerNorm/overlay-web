...
Accepted on July 26, 2026. Phase 1 shipped the workspace foundation on July 29, 2026. Only the `workspaces` app feature is enabled; collaborative chats, Channels, named agents, universal sharing, and shared multi-tenant deployment remain disabled until their individual release gates pass.
