...
workspace-creation boundary for stale collaboration links. Personal member
directory reads expose only the owner, which keeps Memories attribution private
without deleting any legacy rows.
