...
approval, and sandbox-lease records have matching Convex and PostgreSQL schemas.
...
Protocol versioning, validation, sequencing, and HTTP transport remain in the bridge/host
