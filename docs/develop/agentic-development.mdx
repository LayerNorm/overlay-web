...
9. After the release PR checks pass, merge it with a merge commit. Verify the resulting commit on `origin/main`, the production web deployment, and production Convex when applicable.
