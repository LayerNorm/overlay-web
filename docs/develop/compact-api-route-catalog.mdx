...
- `GET /api/v1/surfaces/connections`
- `GET /api/v1/surfaces/connections/[connectionId]/channels`
- `GET, POST /api/v1/surfaces/bindings`
- `DELETE /api/v1/surfaces/bindings/[bindingId]`
