...
5. Keep only publishable docs in `docs/`; internal reports, authenticated screenshots, and proprietary design references stay in an access-controlled system outside this repository.
