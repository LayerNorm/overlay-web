...
Postgres app-data support is split into phases. Phase 1 lets operators provision, validate, and migrate the database. Keep `database.provider=convex` for the running web app until Postgres repository adapters are implemented.
