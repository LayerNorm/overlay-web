...
- Convex deployment region (app-data hosting).
...
- First-party code, SDKs, and contracts stored directly in this repository are `AGPL-3.0-only`.
- Third-party material and separate submodules retain their own licenses.
