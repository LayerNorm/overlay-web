...
Run `npm run license:check`. The check validates first-party manifests and legal files and audits declared runtime dependency licenses against `scripts/ci/license-allowlist.json`.
