...
Knowledge indexing and retrieval run inside the Convex deployment using Convex vector search plus the configured embeddings provider. The browser and API contracts are provider-independent.
