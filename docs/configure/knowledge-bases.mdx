...
1. Open **Knowledge** under **Projects**.
2. Create a knowledge base.
3. Drop files into the source panel or add pasted text.
4. Wait for each source to become **Ready**.
5. Search the source set or ask questions in the knowledge-base chat.
6. Open **Share** to grant viewer or editor access.

Viewers can search sources and create their own private conversations grounded in the knowledge base. Editors can also add, disable, retry, and remove sources. Only the owner can delete or redistribute the knowledge base through the normal workspace.
