...
`BETTER_AUTH_DATABASE_URL` is auth state. Application data always lives in the Convex deployment. Keep the auth database separately named and independently migratable.
