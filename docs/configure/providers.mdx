...
| Database | `convex`, `postgres` | `convex` is the hosted/default app-data provider. `postgres` supports users, chat, projects, files, notes, generated outputs, memory, and knowledge retrieval; later parity phases still cover automations, integrations, and billing controls. |
