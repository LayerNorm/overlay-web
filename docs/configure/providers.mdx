...
| --- | --- | --- |
| Auth | `workos`, `oidc`, `keycloak`, `none` | `workos` is the hosted default. `oidc` and `keycloak` verify bearer/access tokens through discovery JWKS; browser callback wiring is deployment-specific. |
