...
// Verified $0.00/$0.00 on the Vercel AI Gateway catalog (/v1/models). Ling 3.0
// Flash family (124B MoE) — same lineage as prior runs, so results stay
// comparable. `providerOptions.gateway.has` only supports 'implicit-caching'|
// 'vision'; it is NOT a free-tier filter and is ignored for cost purposes.
export const FREE_MODEL_ID = 'inclusionai/ling-3.0-flash-sante-free'
